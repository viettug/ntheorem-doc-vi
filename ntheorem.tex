...
Trong ví dụ sau,
\begin{verbatim}
  \newtheorem{foobar}{Mệnh đề}
\end{verbatim}
ta có |THM| với tên là |Mệnh đề|, nhưng tên của môi trường
...
\begin{center}
	...
	\else
		\includegraphics[scale=.7]{thm.ps}
	\fi
\end{center}
...
\DescribeMacro\theoremseparator
  |\theoremseparator{|\meta{sep}|}|: %%\meta{thing} %%separates the 
...
\DescribeMacro\theoremclass\option{\bslash theoremclass}\\
